...
TEST(BufferAllocatorTest, AllocateTEST_1) {
    ...
    BufferAlloc allocator(buffer, buffer + test_size);
...
*/
TEST(BufferAllocatorTest, RandomAlloc_Test1) {
...
TEST(BufferAllocatorTest, RandomAlloc_Test2) {

    const size_t test_size = 4096 * 1000;
    char *buffer = new char[test_size];
    BufferAlloc allocator(buffer, buffer + test_size);
